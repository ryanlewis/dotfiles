...
tools() {
    ...
    local -a tools_data=(
        ...
        "Custom:🔄 update:Update mise tools, system packages & bun"
        ...
        "Dev:🔍 hunk:Diff viewer/pager"
        "Dev:🐙 gh:GitHub CLI"
        "Dev:☁️  cf:Cloudflare CLI"
    ...
    # ── Default colourful output, paged through bat ───────────
    {
        ...
        print -r -- "${C_brmagenta}• update${C_reset}  - Update mise tools, system packages & bun"
        ...
        print -r -- "${C_bryellow}• hunk${C_reset}     - Diff viewer/pager"
        print -r -- "${C_bryellow}• gh${C_reset}       - GitHub CLI"
        print -r -- "${C_bryellow}• cf${C_reset}       - Cloudflare CLI"
        ...
        print -r -- "${C_bryellow}• mdt${C_reset}      - Markdown viewer (TUI)"
        ...
        print -r -- "${C_bryellow}• nvim${C_reset}     - Neovim modal editor"

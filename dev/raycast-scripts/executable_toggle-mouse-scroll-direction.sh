...
# @raycast.description Toggle between natural and traditional mouse scrolling

# Documentation:
# @raycast.description Switches the scroll direction for your mouse between natural (iOS-style) and traditional (Windows-style)
# @raycast.author Ryan Lewis
# @raycast.authorURL https://github.com/ryanlewis/raycast-scripts
